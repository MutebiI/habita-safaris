...
// // //   )
// // // }
// // // components/destinations/DestinationsPage.tsx
...
// // type Category = 'national-parks' | 'wildlife' | 'cultural' | 'adventure' | 'lakes';
...
// //       {/* Hero Section */}
// //       <section className="relative h-96 bg-gradient-to-r from-blue-900 to-green-900">
// //         <div className="absolute inset-0 bg-black opacity-40"></div>
// //         <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center">
// //           <h1 className="text-5xl font-bold mb-4">Discover Uganda</h1>
// //           <p className="text-xl">The Pearl of Africa - Explore Diverse Destinations</p>
// //         </div>
// //       </section>
...
// //         <div className="container mx-auto px-4">
// //           <h2 className="text-2xl font-bold text-center mb-6">Explore by Region</h2>
// //           <div className="flex flex-wrap justify-center gap-2">
// //             {['all', 'western', 'central', 'eastern', 'northern'].map((region) => (
// //               <button
// //                 key={region}
...
// //               >
// //                 {region === 'all' ? 'All Uganda' : `${region} Region`}
// //               </button>
// //             ))}
// //           </div>
// //         </div>
...
// //         <div className="container mx-auto px-4">
// //           <div className="flex flex-wrap justify-center gap-2">
// //             {['all', 'national-parks', 'wildlife', 'cultural', 'adventure', 'lakes'].map((category) => (
// //               <button
// //                 key={category}
...
// //       />
// //       <div className="p-6">
// //         <h3 className="text-xl font-bold mb-2">Bwindi Impenetrable Forest</h3>
// //         <div className="flex gap-2 mb-3">
// //           <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded">Western</span>
// //           <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded">National Park</span>
// //         </div>
// //         <p className="text-gray-600 mb-4">
// //           Home to nearly half of the world's mountain gorillas. UNESCO World Heritage Site.
// //         </p>
...
// // Types for TypeScript
// type Region = 'all' | 'western' | 'central' | 'eastern' | 'northern';
// type Category = 'all' | 'gorilla-trekking' | 'wildlife-safari' | 'adventure' | 'scenic' | 'primate-watching' | 'wilderness';
...
//   // Your original destinations data - ENHANCED with region/categories AND ITINERARY
...
//   return (
//     <div className="min-h-screen bg-gray-50">
//       {/* Hero Section - USING YOUR BETTER DESIGN */}
//       <section className="relative h-96 bg-cover bg-center" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1544551763-46a013bb70d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80")'}}>
//         <div className="absolute inset-0 bg-black bg-opacity-50"></div>
//         <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
//           <h1 className="text-5xl md:text-6xl font-bold mb-6">Uganda's Wonders</h1>
...
//       {/* Region Filter - IMPROVED STYLING */}
//       <section className="py-8 bg-white">
//         <div className="container mx-auto px-4">
...
//       {/* Category Tabs - USING YOUR TYPE CATEGORIES */}
...
//       {/* Destinations Grid - USING YOUR SUPERIOR CARD DESIGN */}
//       <section className="py-20 bg-gray-50">
//         <div className="container mx-auto px-4">
//           <div className="text-center mb-16">
//             <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
...
//             </h2>
//             <p className="text-xl text-gray-600 max-w-2xl mx-auto">
//               From mountain gorillas to spectacular waterfalls, explore the best of Uganda with Igara Tour & Safaris
//             </p>
//           </div>
...
export default function DestinationsPage() {
  ...
  const destinations: Destination[] = [
    // WESTERN REGION
    {
      ...
      region: "western",
      categories: ["gorilla-trekking", "wildlife-safari"],
      image: "/images/destinations/bwindi-gorillas.jpg", // You'll replace this
      description: "Home to nearly half of the world's remaining mountain gorillas",
      bestTime: "June-August, Dec-Feb",
      highlights: ["Mountain Gorillas", "Primates", "Rainforest", "UNESCO Site"],
      duration: "3 Days / 2 Nights",
